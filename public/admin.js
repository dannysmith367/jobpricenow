  ...
  function renderStats() {
    ...
    const dailyRowsHtml = stats.daily && stats.daily.length
      ? stats.daily.map((d) => `
        ...
        `).join("")
      : `<tr><td colspan="5" class="sub">No activity yet.</td></tr>`;
    ...
    const dailyTableHtml = `
      ...
      <div style="overflow-x:auto;">
        <table class="stats-daily-table">
          <thead>
            <tr><th>Date</th><th>Estimates</th><th>Paid</th><th>Comp'd</th><th>Revenue</th></tr>
          </thead>
    ...
    container.innerHTML = cardsHtml + topJobsHtml + dailyTableHtml;
  }
